...
?>
  ...
  <div class="container">
    <div style="margin-top: 100px;">
      ...
      echo (count($_SESSION['cart']['items']) == 1) ? "<h3>Empty Card</h3>" : " "; ?>
    </div>
        ...
        <article class="product">
          ...
          <footer class="content">
            ...
            <h2 class="full-price" style="color:white;background-color:#0096db">
              <?php $_SESSION['full_price'] += $row['item_price'];
              echo $row['item_price'] . " $" ?>
            </h2>
    ...
    <footer id="site-footer">
      <div class="container clearfix">
        ...
        <div class="right">
          ...
          <?php if (count($_SESSION['cart']['items']) > 1) {
          ?>
          ...
          <?php
            ...
            <Button style="background-color:#0096db;color:white;width:100%" class="btn mt-2">
              <a style="color:white" href="http://localhost/pharmacy/index.php">Continue Shopping</a>
            </Button>
          <?php } ?>
